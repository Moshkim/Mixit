...
- (int) openInputFile: (NSString*) fileURL {
    ...
    // !!! seekeing the subtitles doesn't work
    // so we remove the subtitles streams from the context
    // until ffmpeg people or us will fix that
    // this works. seeking works and video and audio is okay
